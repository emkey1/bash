...
/* iSH-AOK: posix_vars[] pointed at variables that are thread-local now,
...
aok_fix_posix_vars ()
{
  ...
  posix_vars[aok_i].posix_mode_var = &interactive_comments;
  aok_i++;
  posix_vars[aok_i].posix_mode_var = &source_uses_path;
  aok_i++;
  posix_vars[aok_i].posix_mode_var = &expaliases_flag;
  aok_i++;
  posix_vars[aok_i].posix_mode_var = &inherit_errexit;
  aok_i++;
  posix_vars[aok_i].posix_mode_var = &print_shift_error;
  aok_i++;
  aok_i++;
}
