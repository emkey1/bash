...
__thread struct user_info current_user =
{
...
__thread int debugging_login_shell = 0;
...
/* Do we have /dev/fd? */
#ifdef HAVE_DEV_FD
__thread int have_devfd = HAVE_DEV_FD;
#else
int have_devfd = 0;
#endif
...
#endif
__thread int wordexp_only = 0;		/* Do word expansion only */
__thread int protected_mode = 0;		/* No command substitution with --wordexp */

__thread int pretty_print_mode = 0;	/* pretty-print a shell script */
...
static __thread struct {
  ...
  { "debug", Int, 0, (char **)0x0 },
#if defined (DEBUGGER)
  { "debugger", Int, 0, (char **)0x0 },
#endif
#if defined (TRANSLATABLE_STRINGS)
  { "dump-po-strings", Int, 0, (char **)0x0 },
  { "dump-strings", Int, 0, (char **)0x0 },
#endif
  { "help", Int, 0, (char **)0x0 },
  { "init-file", Charp, (int *)0x0, 0 },
  { "login", Int, 0, (char **)0x0 },
  { "noediting", Int, 0, (char **)0x0 },
  { "noprofile", Int, 0, (char **)0x0 },
  { "norc", Int, 0, (char **)0x0 },
  { "posix", Int, 0, (char **)0x0 },
  { "pretty-print", Int, 0, (char **)0x0 },
#if defined (WORDEXP_OPTION)
  { "protected", Int, 0, (char **)0x0 },
#endif
  { "rcfile", Charp, (int *)0x0, 0 },
#if defined (RESTRICTED_SHELL)
  { "restricted", Int, 0, (char **)0x0 },
#endif
  { "verbose", Int, 0, (char **)0x0 },
  { "version", Int, 0, (char **)0x0 },
#if defined (WORDEXP_OPTION)
  { "wordexp", Int, 0, (char **)0x0 },
#endif
  { (char *)0x0, Int, (int *)0x0, (char **)0x0 }
};

/* iSH-AOK: long_args[] pointed at variables that are thread-local now,
...
aok_fix_long_args ()
{
  ...
  long_args[aok_i].int_value = &debugging;
  aok_i++;
#if defined (DEBUGGER)
  long_args[aok_i].int_value = &debugging_mode;
  aok_i++;
#endif
#if defined (TRANSLATABLE_STRINGS)
  long_args[aok_i].int_value = &dump_po_strings;
  aok_i++;
  long_args[aok_i].int_value = &dump_translatable_strings;
  aok_i++;
#endif
  ...
  aok_i++;
  long_args[aok_i].int_value = &no_line_editing;
  aok_i++;
  long_args[aok_i].int_value = &no_profile;
  aok_i++;
  long_args[aok_i].int_value = &no_rc;
  aok_i++;
  long_args[aok_i].int_value = &posixly_correct;
  aok_i++;
  long_args[aok_i].int_value = &pretty_print_mode;
  aok_i++;
#if defined (WORDEXP_OPTION)
  ...
  aok_i++;
#endif
  long_args[aok_i].int_value = &verbose_flag;
  aok_i++;
  long_args[aok_i].int_value = &do_version;
  aok_i++;
#if defined (WORDEXP_OPTION)
  long_args[aok_i].int_value = &wordexp_only;
  aok_i++;
#endif
  aok_i++;
}
...
__thread char *shell_script_filename; 	/* shell script */
