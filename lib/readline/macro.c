...
static __thread int executing_macro_index;

/* The current macro string being built.  Characters get stuffed
   in here by add_macro_char (). */
static __thread char *current_macro = (char *)NULL;

/* The size of the buffer allocated to current_macro. */
static __thread int current_macro_size;

/* The index at which characters are being added to current_macro. */
static __thread int current_macro_index;
...
static __thread struct saved_macro *macro_list = (struct saved_macro *)NULL;

static __thread int macro_level = 0;
