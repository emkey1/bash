...
__thread static struct _tc_string tc_strings[] =
{
  ...
  { "kP", 0 },	/* page up */
  { "kd", 0 },
  { "ke", 0 },	/* end keypad mode */
  { "kh", 0 },	/* home */
  { "kl", 0 },
  { "kr", 0 },
  { "ks", 0 },	/* start keypad mode */
  { "ku", 0 },
  { "le", 0 },
  { "mm", 0 },
  { "mo", 0 },
...
/* iSH-AOK: tc_strings[] pointed at variables that are thread-local now,
...
aok_fix_tc_strings ()
{
  ...
  tc_strings[aok_i].tc_value = &_rl_term_at7;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_DC;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_clrscroll;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_IC;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_clreol;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_clrpag;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_cr;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_dc;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_ei;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_ic;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_im;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kD;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kH;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kI;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kN;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kP;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kd;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_ke;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kh;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kl;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_kr;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_ks;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_ku;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_backspace;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_mm;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_mo;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_forward_char;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_pc;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_se;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_so;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_up;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_visible_bell;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_vs;
  aok_i++;
  tc_strings[aok_i].tc_value = &_rl_term_ve;
  aok_i++;
}
