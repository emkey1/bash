...
/* Set the environment variables LINES and COLUMNS to lines and cols,
   respectively. */
static __thread char setenv_buf[INT_STRLEN_BOUND (int) + 1];
static __thread char putenv_buf1[INT_STRLEN_BOUND (int) + 6 + 1];	/* sizeof("LINES=") == 6 */
static __thread char putenv_buf2[INT_STRLEN_BOUND (int) + 8 + 1];	/* sizeof("COLUMNS=") == 8 */
...
{
  static __thread char *home_dir = (char *)NULL;
  struct passwd *entry;
