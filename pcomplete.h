...
extern __thread HASH_TABLE *prog_completes;

extern __thread char *pcomp_line;
extern __thread int pcomp_ind;

extern __thread int prog_completion_enabled;
extern __thread int progcomp_alias;

/* Not all of these are used yet. */
extern __thread ITEMLIST it_aliases;
extern __thread ITEMLIST it_arrayvars;
extern __thread ITEMLIST it_bindings;
extern __thread ITEMLIST it_builtins;
extern __thread ITEMLIST it_commands;
extern __thread ITEMLIST it_directories;
extern __thread ITEMLIST it_disabled;
extern __thread ITEMLIST it_enabled;
extern __thread ITEMLIST it_exports;
extern __thread ITEMLIST it_files;
extern __thread ITEMLIST it_functions;
extern __thread ITEMLIST it_groups;
extern __thread ITEMLIST it_helptopics;
extern __thread ITEMLIST it_hostnames;
extern __thread ITEMLIST it_jobs;
extern __thread ITEMLIST it_keywords;
extern __thread ITEMLIST it_running;
extern __thread ITEMLIST it_services;
extern __thread ITEMLIST it_setopts;
extern __thread ITEMLIST it_shopts;
extern __thread ITEMLIST it_signals;
extern __thread ITEMLIST it_stopped;
extern __thread ITEMLIST it_users;
extern __thread ITEMLIST it_variables;

extern __thread COMPSPEC *pcomp_curcs;
extern __thread const char *pcomp_curcmd;
